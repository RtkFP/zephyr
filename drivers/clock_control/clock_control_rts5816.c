...
#include <zephyr/dt-bindings/clock/rts5816_clock.h>
#include "zephyr/arch/common/sys_io.h"
#include "zephyr/device.h"
#include <errno.h>
#include <stdint.h>
#include "clock_control_rts5816_control.h"
#include "clock_control_rts5816_gpll.h"

#define DT_DRV_COMPAT realtek_rts5816_clock
...
static uint32_t rlx_pke_get_rate(const struct device *dev, const struct clk_rlx *clk)
{
	...
	div = (reg >> 2) & 0x7;
	rate = src_clk_frq / m_div_array[div];
